...
import com.jose.aerolinea.mappers.AerolineaMapper;
...
CommonServiceImpl<AerolineaDTO,Aerolinea,AerolineaMapper,AerolineaRepository> implements AerolineaService{
